...
(他の第3陣営のソロ勝利の場合は除く)  
タスク量はオプションで設定することが可能  
クルーのタスクと違い同じタスクが複数回割り当てられることがある  
自身をキルすることができるプレイヤーの位置を矢印で把握できる  
透明化ボタンを押すことで一定時間透明になりターゲット不可になる  
妖狐はサボタージュを直すことができない ※オプションで調整可能  
自身をキルすることができるプレイヤー以外を背徳者にすることができる  ※オプションでON/OFF可能  
妖狐はクルー側の生存人数にはカウントされない（1妖狐1クルー1インポスターでインポスター勝利のフラグが立つ　※妖狐がタスクを終えていれば妖狐の勝利）
