...
namespace TheOtherRoles {
    public class CustomOptionHolder {
        ...
        public static void Load() {
            ...
            madmateSpawnRate = CustomOption.Create(370, cs(Madmate.color, "Madmate"), rates, null, true);
            madmateCanDieToSheriff = CustomOption.Create(371, "Madmate Can Die To Sheriff", false, madmateSpawnRate);
            madmateCanEnterVents = CustomOption.Create(372, "Madmate Can Enter Vents", false, madmateSpawnRate);
            madmateHasImpostorVision = CustomOption.Create(373, "Madmate Has Impostor Vision", false, madmateSpawnRate);
